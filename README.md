...
## 🛠️ Tech Stack & Key Analytics Concepts Used
* **Analytics Engine:** Advanced Excel Dashboard Engineering, Power Query & Pivot Tables
* **Data Visualization:** Interactive UI/UX Layout Design, Dynamic Slicers, Dual-Axis Combination Charts
* **Statistical Frameworks:** Pareto Analysis (80/20 Rule), Trend Modeling, Customer Spending Classification
...
By converting fragmented cash-register logs into an automated financial dashboard, this project bridges the gap between raw backend transaction logs and real-world franchise management. Stakeholders can immediately detect peak revenue hours to balance employee staffing, monitor shifting customer ticket averages, and protect baseline profit margins by ordering stock based on high-performing item trends.

---

## 📬 Contact & Collaboration
* **Developer:** Muideen Abiodun Ogunlowo
* **Email:** ogunlowomuideenabiodun@gmail.com
* **Timezone:** Fully aligned with UK & Central European Time (Zero Timezone Friction)
